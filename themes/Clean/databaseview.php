...
{//process data
    ...
    header('Location:CustomerList_Pager_WaterMelon.php');
}
...
{//show records
    ...
    while($row = mysqli_fetch_assoc($result))
    {
        ...
        $Image = '<img src="data:image/jpg;base64,' . base64_encode($row['image']) . '" style="max-width:50px"/>';
...
{//data exists, show it
    ...
    echo 'Image: <b> ' . $Image . '</b><br /> ';
    echo 'Uploaded image: <img src="uploads/customer' . $id . '.jpg" />'.'<br/>';
...
echo '<p><a href="CustomerList_Pager_WaterMelon.php">Go Back</a></p>';
